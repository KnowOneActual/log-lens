...
## [0.7.1] - 2026-03-03
### Added
- **AI-Driven Context**: Introduced `GEMINI.md` to capture project standards and AI best practices (local-only).

### Changed
- **Local Environment**: Updated `.gitignore` to prevent AI context files from being tracked.
